// Crerates an object to keep track of values.
const Calculator = {
    //This will display 0 on tthe calculator screen.
    Display_Value: '0',
    //This will hold the first operand for any expressions, we set it to null for now.
    First_Operand: null,
    //This checks wether or nott the second operand has been inputted by the user
    Wait_Second_Operand: false,
    //This will hold the operator, we se it to null for now.
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operatorkey is pressed we convert the current number
    ...
    if (First_Operand == null) {
        ...
        //in tthe Perform_Calculation object and the function that matches the
